...
###############################################################################
# load ECMWF ENS data
# TBL:  Latitude: 40.12498, Longitude: -105.23680 
# Time zone: UTC-7 (Etc/GMT+7)
metadata1 = pd.read_csv('C:/Users/81095/PY/ENS/TBL_2017_2018.csv')
metadata2 = pd.read_csv('C:/Users/81095/PY/ENS/TBL_2019_2020.csv')
# Define a new dataframe: "data_TBL", which stores ensemble forecasts of 50 members.
data_TBL = pd.DataFrame(columns=[f'EC_GHI_{x+1}' for x in range(50)])
...
for i in range(50):
    ...
    # loop assignment.
    data_TBL[f'EC_GHI_{i+1}'] = ghi_df['ghi']
...
# index number "43839" is UTC: 2020-12-31 23:00:00
...
data_target = pd.concat([data_TBL,nsrdb_target],axis=1) 
...
# train
data_train = data_target.iloc[:12194,:]
data_train.index = range(len(data_train))
# test
data_test = data_target.iloc[12194:,:]
