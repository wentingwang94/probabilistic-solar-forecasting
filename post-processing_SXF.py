...
###############################################################################
# load ECMWF ENS data
# SXF:  Latitude: 43.73403, Longitude: -96.62328 
# Time zone: UTC-6 (Etc/GMT+6)
metadata1 = pd.read_csv('C:/Users/81095/PY/ENS/SXF_2017_2018.csv')
metadata2 = pd.read_csv('C:/Users/81095/PY/ENS/SXF_2019_2020.csv')
# Define a new dataframe: "data_SXF", which stores ensemble forecasts of 50 members.
data_SXF = pd.DataFrame(columns=[f'EC_GHI_{x+1}' for x in range(50)])
...
for i in range(50):
    ...
    # loop assignment.
    data_SXF[f'EC_GHI_{i+1}'] = ghi_df['ghi']
...
data_target = pd.concat([data_SXF,nsrdb_target],axis=1) 
...
# train
data_train = data_target.iloc[:12103,:]
data_train.index = range(len(data_train))
# test
data_test = data_target.iloc[12103:,:]
