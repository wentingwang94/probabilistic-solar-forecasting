...
# data_target = pd.read_csv('C:/WWT/论文/ECMWF_ENS/supplementary material/post-processing/data/ENS_DRA.csv',index_col=-2)
# data_target = pd.read_csv('C:/WWT/论文/ECMWF_ENS/supplementary material/post-processing/data/ENS_FPK.csv',index_col=-2)
# data_target = pd.read_csv('C:/WWT/论文/ECMWF_ENS/supplementary material/post-processing/data/ENS_GWN.csv',index_col=-2)
# data_target = pd.read_csv('C:/WWT/论文/ECMWF_ENS/supplementary material/post-processing/data/ENS_PSU.csv',index_col=-2)
# data_target = pd.read_csv('C:/WWT/论文/ECMWF_ENS/supplementary material/post-processing/data/ENS_SXF.csv',index_col=-2)
# data_target = pd.read_csv('C:/WWT/论文/ECMWF_ENS/supplementary material/post-processing/data/ENS_TBL.csv',index_col=-2)
...
# satellite observations 2017--2019
...
bounds = Bounds([0.001,0.001,0.001],[100,100,10000])
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# the CRPS for the raw forecast is not calculated under the Gaussian assumption, but uses the CRPS formula for ensemble forecast

obs_array = data_test['NSRDB_GHI'].values
ens_array = data_test.iloc[:,:50].values

output = em.crps_kernel(obs=obs_array, fcst_ens=ens_array)
crps = output['crpsMean']
