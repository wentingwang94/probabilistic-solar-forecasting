...
###############################################################################
# load ECMWF ENS data
# DRA:  Latitude: 36.62373, Longitude: -116.01947 
# Time zone: UTC-8 (Etc/GMT+8)
metadata1 = pd.read_csv('C:/Users/81095/PY/ENS/DRA_2017_2018.csv')
metadata2 = pd.read_csv('C:/Users/81095/PY/ENS/DRA_2019_2020.csv')
# Define a new dataframe: "data_DRA", which stores ensemble forecasts of 50 members.
data_DRA = pd.DataFrame(columns=[f'EC_GHI_{x+1}' for x in range(50)])
...
for i in range(50):
    ...
    # loop assignment.
    data_DRA[f'EC_GHI_{i+1}'] = ghi_df['ghi']
...
# train
data_train = data_target.iloc[:12301,:]
data_train.index = range(len(data_train))
# test
data_test = data_target.iloc[12301:,:]
...
bounds = Bounds([0.001,0.001,0.001],[30,10,1000])
